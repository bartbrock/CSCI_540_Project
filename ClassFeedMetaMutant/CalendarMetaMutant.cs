...
namespace CSCI_540_Project_Mutant

{
    public static class CalendarData
    {
        ...
        public static string CalendarURL = "http://calendar.churchart.com/Calendar/RSS.ashx?ci=L6N8N8J4I3I3O9L6I3";  // deleted last two characters for MUTANT TESTING
    ...
    public class CalendarFeed
    {
        ...
        public IEnumerable<Rss> GetRssFeed(string groupID, string numDays, string rssURL)
        {
            ...
            // Validate Group ID
            _index = Array.IndexOf(CalendarData.GroupIdTable, groupID);   // replaced _index with _errorCode for MUTANT TESTING
            if (_index < 0)
            {
            ...
            if (GoodUrl)
            {
                ...
                if (feedXml != null)  // changed != to == for MUTANT TESTING 
                {
        ...
        public Rss CalendarError(int errorCode)
        {
            ...
            if (errorCode != 0)  // verify error exists
            {
                ...
                _errorReturn.Title = "Error Code = " + errorCode.ToString();
                 _errorReturn.Description = "Contact website administrator. ";   // commented out for MUTANT TESTING
